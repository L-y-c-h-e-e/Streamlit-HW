...
def app():
    ...
    #data_analysis_time(test_df) крашится в streamlit cloud.
    st.warning("Здесь также пришлось убрать функцию, так что напишу ее вывод вручную")
    st.write("Время выполнения без распараллеливания: 3.40 секунд")
    st.write("Время выполнения c распараллеливанием: 1.80 секунд")
    st.write("Разница во времени: 1.60 секунд")
